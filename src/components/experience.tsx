  ...
  return (
    <section id="experience" className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Experience & Certifications</h2>
        ...
        <div className="space-y-8">
          ...
          <Card className="bg-secondary/50 border-secondary">
            <CardHeader>
              ...
              <CardDescription>June 2024 – July 2024 | Make360, Landran, Mohali</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
