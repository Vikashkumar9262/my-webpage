...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A digital gallery showcasing a personal collection of vintage and classic cameras, highlighting their unique history and design.",
      techStack: ["Next.js", "React", "Tailwind CSS"],
      metric: "Personal hobby project.",
      githubUrl: "#",
      demoUrl: "#",
