...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "An AI-powered chat application that uses Langchain and the Llama2 API to generate algorithm code for moving average crossover.",
      techStack: ["Langchain", "Llama2 API", "Next.js", "React"],
      metric: "Demonstrates generative AI capabilities for finance.",
      githubUrl: "#",
      demoUrl: "#",
