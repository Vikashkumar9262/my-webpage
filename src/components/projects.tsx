...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "LLM Chat App",
      description: "An AI-powered chat application demonstrating capabilities in building interactive web apps with Large Language Models.",
      techStack: ["Streamlit", "Python", "LLM"],
      metric: "Real-time response generation.",
      githubUrl: "#",
      demoUrl: "#",
